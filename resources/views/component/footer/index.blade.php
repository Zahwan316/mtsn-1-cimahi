        ...
        <div class="space-y-4">
            <div class="flex items-center gap-3">
                <div class="h-12 w-12 p-1 bg-white rounded-xl shadow-md">
                    <img src="{{ asset('img/logoman-2.png') }}" class="w-full h-full object-contain" alt="Logo MTsN Cimahi" />
                </div>
            ...
            <p class="text-sm leading-relaxed text-slate-300 font-light">
                Madrasah Tsanawiyah Negeri Kota Cimahi berkomitmen melahirkan generasi yang unggul dalam IPTEK, kokoh dalam IMTAQ, berakhlak mulia, serta berwawasan lingkungan.
            </p>
            <div class="flex items-center gap-3 pt-2">
                <a href="#" class="p-2 bg-white/5 hover:bg-emerald-600 hover:text-white rounded-lg transition-colors duration-300" aria-label="Facebook">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M9 8H7v3h2v9h3v-9h3l.5-3H12V6c0-.88.39-1 1-1h2V2h-3c-2.5 0-3 1.5-3 3v3z"/></svg>
                </a>
                <a href="#" class="p-2 bg-white/5 hover:bg-emerald-600 hover:text-white rounded-lg transition-colors duration-300" aria-label="Instagram">
                ...
                <a href="#" class="p-2 bg-white/5 hover:bg-emerald-600 hover:text-white rounded-lg transition-colors duration-300" aria-label="YouTube">
