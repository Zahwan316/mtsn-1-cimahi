<!-- Navbar Sticky dengan efek backdrop blur semi-transparan agar mewah -->
<nav class="w-full h-20 bg-[#0B2D72]/95 backdrop-blur-md text-white sticky top-0 z-50 border-b border-white/10 px-6 md:px-12 transition-all duration-300">
    <div class="max-w-7xl mx-auto h-full flex flex-row items-center justify-between">
        ...
        <a href="/" class="flex items-center gap-3 h-full group">
            <div class="h-12 w-12 p-0.5 bg-white rounded-xl shadow-md transition-transform group-hover:scale-105">
                <img src="{{ asset('img/logoman-2.png') }}" class="w-full h-full object-contain" alt="Logo MTsN Kota Cimahi" />
            </div>
            <div class="flex flex-col">
                <span class="font-extrabold text-base tracking-wide leading-tight group-hover:text-emerald-400 transition">MTsN 1 KOTA CIMAHI</span>
        ...
        <!-- Menggunakan trik hover:group untuk dropdown murni CSS (Tanpa JS tambahan) -->
        <div class="hidden md:flex flex-row items-center gap-1 lg:gap-2 h-full font-medium text-sm">
            ...
            <div class="relative h-full flex items-center group/dropdown">
                <button class="px-4 py-2 rounded-xl hover:bg-white/10 flex items-center gap-1.5 transition-all duration-200">
                    <span>Profil</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-slate-400 group-hover/dropdown:rotate-180 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>
                <!-- Isi Dropdown (Muncul saat button di-hover) -->
            ...
            <!-- Tombol CTA: PPDB -->
            <a href="#ppdb" class="ml-4 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white text-xs uppercase font-bold tracking-wider rounded-xl shadow-lg shadow-emerald-900/20 transition-all duration-200 hover:-translate-y-0.5">
                PPDB Online
            </a>
        </div>
        ...
        <div class="flex md:hidden">
            <button class="p-2 rounded-xl bg-white/10 hover:bg-white/25 transition">
