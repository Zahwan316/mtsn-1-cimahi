<div>
    ...
    <div class="bg-white rounded-2xl shadow-md relative border border-slate-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group">
        <div>
            <!-- Bagian Media / Gambar -->
            <div
                class="w-full h-auto bg-slate-100 relative overflow-hidden flex items-center justify-center border-b border-slate-100">
                ...
                <span
                    class="absolute top-3 left-3 bg-[#0B2D72] text-white text-xs font-bold px-3 py-1.5 rounded-lg shadow-md tracking-wider">
                    {{ $year }}
                </span>
            </div>

            <!-- Bagian Konten / Detail -->
            <div class="w-full p-5 space-y-3 absolute bottom-0 bg-black/20">
                <div>
                    <h4
                        class="text-lg font-bold text-white leading-snug group-hover:text-emerald-500 transition-colors mb-2">
                        {{ $name }}
                    </h4>
                    <span class="text-xs  font-bold text-slate-200 tracking-wider block">{{ $job }}</span>
                </div>
            </div>
        </div>
    </div>
